myApp.controller('adventureCtrl', function ($scope, $rootScope, $location, $compile) {

    $scope.order = JSON.parse(sessionStorage.getItem('order'));
    if ($scope.order === null) { $scope.order = []; };

    var genre = "приключения";
    ...
    $scope.addAdvent = function ($event) {
